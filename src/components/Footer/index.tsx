    ...
    <div id="footer">
          ...
          <div className="row">
            ...
            <div className="col-xl-2 col-lg-2 col-md-3">
              <div className="footer-links">
                ...
                <ul>
                  <li><a href="#!"><span>Browse </span></a></li>
                  <li><a href="#!"><span>Add Blog</span></a></li>
            ...
            <div className="col-xl-2 col-lg-2 col-md-3">
              <div className="footer-links">
                <h3>For Coffee Die hards</h3>
                <ul>
                  <li><a href="#!"><span>Browse Coffee</span></a></li>
                  <li><a href="#!"><span>Learning Dashboard</span></a></li>
            ...
            <div className="col-xl-2 col-lg-2 col-md-3">
              <div className="footer-links">
                ...
                <ul>
                  ...
                  <li><a href="#1"><span>Privacy Policy</span></a></li>
                  <li><a href="#1"><span>Terms of Use</span></a></li>
                </ul>
              </div>
            </div>
      ...
      <div className="footer-bottom-section">
        <div className="container">
          <div className="row">
            <div className="col-xl-12">
              © 2021 <strong>Jango Barista</strong>. All Rights Reserved.
				</div>
          </div>
        </div>
      </div>
